			...
			<div className="overflow-hidden w-[1900px] max-w-full max-h-[400px] mb-12">
				<div className="sliderContent w-[400%] max-h-full flex">
					...
					<div className="navManual max-w-[1700px] mt-[410px] flex absolute justify-center">
						...
						<label htmlFor="radio1" className="manualBtn p-[10px] cursor-pointer rounded-full hover:bg-[#0080ff] outline outline-1 outline-[#0080ff]"></label>

						<label htmlFor="radio2" className="manualBtn p-[10px] cursor-pointer rounded-full hover:bg-[#0080ff] outline outline-1 outline-[#0080ff]"></label>

						<label htmlFor="radio3" className="manualBtn p-[10px] cursor-pointer rounded-full hover:bg-[#0080ff] outline outline-1 outline-[#0080ff]"></label>
					</div>
				</div>
			</div>
        </>
